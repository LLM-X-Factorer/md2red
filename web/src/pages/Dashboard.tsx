  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <div className="rounded-xl bg-white border border-gray-200 shadow-sm p-6 flex items-center justify-center">
          <Link
            to="/upload"
        ...
        <div>
          ...
          <div className="space-y-3">
            {history.slice(-5).reverse().map((r: any) => (
              <div key={r.id} className="flex items-center justify-between rounded-lg bg-white border border-gray-200 shadow-sm px-5 py-3">
                <div>
